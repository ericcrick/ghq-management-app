...
interface Directory {
  [letter: string]: DirectoryItem[];
}

const tabs = [
  { name: "Personl Information", href: "#", current: true },
  { name: "Promotions", href: "#", current: false },
  { name: "Studey Leave", href: "#", current: false },
  { name: "Next of Kin/Beneficiaries", href: "#", current: false },
...
const profile: {
  ...
  fields: {
    ...
    Grade: "Senior Front-End Developer",
    Department: "Product Development",
    Location: "San Francisco",
    Unit: "Oasis, 4th floor",
    Salary: "$145,000",
...
export default function Employees() {
  return (
    <>
      <div className="rel z-0 flex flex-1 overflow-hidden">
              ...
              <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                  ...
                  <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                    ...
                    <div className="mt-12 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
                      <button
                        type="button"
        ...
        <aside className="hidden w-96 flex-shrink-0 border-r border-gray-200 xl:order-first xl:flex xl:flex-col">
          <div className="px-6 pb-4 pt-6">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Search records of 3,018 employees
            </p>
